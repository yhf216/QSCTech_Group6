      ...
      fetch(API_URL + url, {
        ...
        .then((response) => {
          if (response.ok) {
            ...
            notification.error({
              title: "Network Error",
              content: `Something went wrong when fetching data from server.
URL: ${API_URL + url}
      ...
      fetch(API_URL + url, {
        ...
        .then((response) => {
          if (response.ok) {
            ...
            notification.error({
              title: "Network Error",
              content: `Something went wrong when sending data to server.
URL: ${API_URL + url}
Status: ${response.status}`,
              meta: new Date().toLocaleString(),
            });
      ...
      fetch(API_URL + url, {
        ...
        .then((response) => {
          if (response.ok) {
            ...
            notification.error({
              title: "Network Error",
              content: `Something went wrong when updating data on server.
URL: ${API_URL + url}
Status: ${response.status}`,
              meta: new Date().toLocaleString(),
            });
      ...
      fetch(API_URL + url, {
        ...
        .then((response) => {
          if (response.ok) {
            ...
            notification.error({
              title: "Network Error",
              content: `Something went wrong when deleting data from server.
URL: ${API_URL + url}
Status: ${response.status}`,
              meta: new Date().toLocaleString(),
            });
